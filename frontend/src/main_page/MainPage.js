      ...
      <div className="homepage-card">
        <header className="homepage-header">
          ...
          <div className="auth-buttons">
            <button className="main-login" onClick={handleLoginSubmit}>Log in</button>
            <button className="main-signup" onClick={handleLoginSubmit}>Sign up</button>
          </div>
        </header>
        ...
        <main className="homepage-main">
          <div className="text-section">
            <h1 className="main-heading">
              Organize your team’s work<br />with a powerful board.
            </h1>
            <p className="description">
              Create tasks, assign them, track progress and stay focused with a collaborative workspace.
            </p>
            <div className="cta-buttons">
              <button className="try-btn" onClick={handleLoginSubmit}>Try it!</button>
            </div>
          </div>
